    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul className="nav navbar-nav navbar-right">
          ...
          <li><Link to="/login"><i className="fa fa-flame fa-fw" /> Login</Link></li>
          <li><Link to="/register"><i className="fa fa-flame fa-fw" /> Register</Link></li>
          <li><Link to="/profile"><i className="fa fa-flame fa-fw" /> Profile</Link></li>
        </ul>
      </div>
    </div>
  </nav>
